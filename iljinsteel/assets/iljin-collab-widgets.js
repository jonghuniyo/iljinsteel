(function () {
  ...
  function injectQuickMenuButtons() {
    ...
    panels.forEach((panel) => {
      ...
      if (!panel.querySelector('[data-ilfocus-trigger="true"]')) {
        ...
        if (petButton) panel.insertBefore(focusBtn, petButton);
      ...
      if (!panel.querySelector('[data-ilbattle-trigger="true"]')) {
        ...
        if (petButton) panel.insertBefore(battleBtn, petButton);
  ...
  function installMarketCopyHook() {
    ...
    marketCopyObserver.observe(document.body, { childList: true, subtree: true, characterData: true });
  }
