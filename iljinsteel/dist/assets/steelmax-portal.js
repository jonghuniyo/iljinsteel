(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      .smx-panel{width:min(1180px,96vw);height:min(790px,92vh);min-height:0;border-radius:22px;background:#f8fafc;color:#1e293b;box-shadow:0 26px 80px rgba(15,23,42,.32);display:grid;grid-template-columns:360px minmax(0,1fr);overflow:hidden;border:1px solid rgba(148,163,184,.35);font-family:'Noto Sans KR',system-ui,sans-serif}
      ...
      .smx-main{padding:22px;overflow:auto;min-height:0;overscroll-behavior:contain}
      ...
      .smx-chips{display:flex;gap:6px;flex-wrap:wrap;max-height:84px;overflow:auto;flex-shrink:0;overscroll-behavior:contain}
      ...
      .smx-article{background:#fff;border:1px solid #e2e8f0;border-radius:18px;padding:22px;min-height:100%;display:flex;flex-direction:column;min-width:0}
      .smx-article h2{font-size:24px;line-height:1.28;letter-spacing:-.8px;margin:0 0 10px}
      .smx-article .body{white-space:pre-wrap;font-size:14.5px;line-height:1.85;color:#334155;max-width:850px;min-height:0;overflow:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch}
      ...
      @media(max-width:860px){
        ...
        .smx-main{padding:14px;min-height:0;overflow:auto}
